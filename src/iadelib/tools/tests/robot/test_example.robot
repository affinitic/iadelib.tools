...
#
#  $ bin/test -s iadelib.tools -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src iadelib.tools.testing.IADELIB_TOOLS_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/iadelib/tools/tests/robot/test_example.robot
#
